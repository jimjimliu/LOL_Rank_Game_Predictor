...
create table `match`(
    ...
    `team1_firstTower` TINYINT,
    `team1_firstInhibitor` TINYINT,
    `team1_firstBaron` TINYINT,
    `team1_firstDragon` TINYINT,
    `team1_firstRiftHerald` TINYINT,
    `team1_towerKills` SMALLINT,
    `team1_inhibitorKills` SMALLINT,
    `team1_baronKills` SMALLINT,
    `team1_dragonKills` SMALLINT,
    `team1_vilemawKills` SMALLINT,
    `team1_riftHeraldKills` SMALLINT,
    `team1_dominionVictoryScore` SMALLINT,
    `team1_ban1` SMALLINT,
    `team1_ban2` SMALLINT,
    `team1_ban3` SMALLINT,
    `team1_ban4` SMALLINT,
    ...
    `team2_firstBlood` TINYINT,
    `team2_firstTower` TINYINT,
    `team2_firstInhibitor` TINYINT,
    `team2_firstBaron` TINYINT,
    `team2_firstDragon` TINYINT,
    `team2_firstRiftHerald` TINYINT,
    `team2_towerKills` SMALLINT,
    `team2_inhibitorKills` SMALLINT,
    `team2_baronKills` SMALLINT,
    `team2_dragonKills` SMALLINT,
    `team2_vilemawKills` SMALLINT,
    `team2_riftHeraldKills` SMALLINT,
    `team2_dominionVictoryScore` SMALLINT,
    `team2_ban1` SMALLINT,
    `team2_ban2` SMALLINT,
    `team2_ban3` SMALLINT,
    `team2_ban4` SMALLINT,
