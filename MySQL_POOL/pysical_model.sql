...
create table `match`(
    `id` int not null auto_increment unique key,
    `gameId` MEDIUMINT not null primary key,
    ...
    `team1_firstBaron`SMALLINT(1) not null,
    ...
    `team1_ban4` SMALLINT,
    `team1_ban5` SMALLINT,
    `team2_win` SMALLINT(1) not null,
    `team2_firstBlood` SMALLINT(1) not null,
    `team2_firstTower` SMALLINT(1) not null,
    `team2_team2_firstInhibitor` SMALLINT(1) not null,
    `team2_firstBaron`SMALLINT(1) not null,
    `team2_firstDragon` SMALLINT(1) not null,
    `team2_firstRiftHerald` SMALLINT(1) not null,
